...
OutputBaseFilename=geph-test-setup
Compression=lzma2
...
Source: "E:\geph-electron-win32-ia32\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
